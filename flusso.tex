...
%Un precedente esperimento\cite{Flusso_int} riporta i seguenti risultati per il flusso verticale integrato su tutti i valori del momento al di sopra di un certo valore:

%\begin{center}
%\begin{figure}
%\includegraphics[width=\textwidth]{"flusso_int"} 
%\end{figure}
%\end{center}

%dal quale si evince che 
%\begin{equation}
%\Phi_{v, Rastin}(E \gtrapprox 300 MeV) = 90 m^{-2} s^{-1}
%\end{equation}

%!!!!! che è compatibile con il nostro entro due sigma !!!
